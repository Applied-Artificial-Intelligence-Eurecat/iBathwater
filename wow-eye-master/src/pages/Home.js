...
export const Home = () => {
    return (
        <>
            <Header title={'iBATHWATER Semantic Sensor Hub for bringing semantic interoperability between water devices'}/>
                ...
                <div className="container-fluid p-0">
                    <div className="row no-gutters">
                        ...
                        <div className="col-lg-6 order-lg-1 showcase-text">
                            ...
                            <p className="lead mb-0">Explore all connected information from our Berlin and Barcelona demo-sites</p>
                        </div>
                    </div>
                </div>
