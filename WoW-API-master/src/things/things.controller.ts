...
export class ThingsController {
    ...
    findOneProperty(@Param('id') id: string, @Param('propType') propType: string): Promise<any>{
        return this.thingService.findOneProperty(process.env.ROOT_URL + '/things/'+ id+'/properties/'+propType);
    }
